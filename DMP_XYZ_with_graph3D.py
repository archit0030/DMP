...
def dmp_loop(ax,ax_new,beta,alpha, Nc):
    ...
    T = 0.02
    path = '/home/tshr/Downloads/DMP_cartesian_data2.csv'
...
if __name__ == "__main__":
    ...
    with open('/home/tshr/xyz0.csv', 'r') as csvfile:
        reader = csv.reader(csvfile)
        x = [float(row[0]) for row in reader]

    with open('/home/tshr/xyz1.csv', 'r') as csvfile:
        reader = csv.reader(csvfile)
        y = [float(row[0]) for row in reader]

    with open('/home/tshr/xyz2.csv', 'r') as csvfile:
        reader = csv.reader(csvfile)
