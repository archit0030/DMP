...
class ExampleWaypointActionClient:
    ...
    def example_home_the_robot(self):
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            goal.trajectory.append(self.FillCartesianWaypoint(0.577, -0.014, 0.545 , math.radians(90.9), math.radians(-0.6), math.radians(87.7), 0))
    ...
    def example_cartesian_waypoint_action(self):
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            # os.system('python3 /home/architsharma/catkin_workspace/src/ros_kortex/kortex_examples/src/move_it/healthcare/center_based_reach/final_inverse_kinematics/dynamic_pouring/inverse_kinematics_2.py')
            ...
            x, y, z = coords
            goal.trajectory.append(self.FillCartesianWaypoint(x,  y,  z, math.radians(theta_x_init), math.radians(theta_y_init), math.radians(theta_z_init), 0))
...
#----------------------------------------""""For lifting up the object""""----------------------------------------#


    def taking_height(self):
        self.last_action_notif_type = None
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            # Set y and z waypoints while keeping x constant (use x_init)
            goal.trajectory.append(self.FillCartesianWaypoint(x_init, y_init, 0.507, math.radians(theta_x_init), math.radians(theta_y_init), math.radians(theta_z_init), 0))
...
#----------------------------""""going to pour""""----------------------------#
    ...
    def example_cartesian_waypoint_action_2(self):
        self.last_action_notif_type = None
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            x, y, z = coords
            goal.trajectory.append(self.FillCartesianWaypoint(x+0.012,  y+0.091,  z+0.099, math.radians(theta_x_init), math.radians(theta_y_init), math.radians(theta_z_init), 0))
...
#----------------------------""""Tilting the object to Pour""""----------------------------#
    ...
    def pouring(self):
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            goal.trajectory.append(self.FillCartesianWaypoint(x_init, y_init , z_init, math.radians(53.9), math.radians(-109.9), math.radians(123.8), 0))
            # goal.trajectory.append(self.FillCartesianWaypoint(x_init, -0.256 , 0.5, math.radians(53.9), math.radians(-109.9), math.radians(123.8), 0))
...
#----------------------------""""going to place the object""""----------------------------#
    def going_down(self):
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            goal.trajectory.append(self.FillCartesianWaypoint(x_init, y_init, 0.442 , math.radians(theta_x_init), math.radians(theta_y_init), math.radians(theta_z_init), 0))
    ...
    def main(self):
        ...
        if success:
            ...
            os.system('python3 /home/architsharma/catkin_workspace/src/ros_kortex/kortex_examples/src/move_it/healthcare/center_based_reach/final_inverse_kinematics/dynamic_pouring/reach_near_to_object.py')
            # success &= self.example_clear_faults()
            #*******************************************************************************
            ...
            os.system('python3 /home/architsharma/catkin_workspace/src/ros_kortex/kortex_examples/src/move_it/healthcare/center_based_reach/final_inverse_kinematics/dynamic_pouring/reach_near_to_object2.py')
            ...
            success &= self.example_cartesian_waypoint_action_2()
            success &= self.example_clear_faults()
            
            success &= self.pouring()
            success &= self.example_clear_faults()
