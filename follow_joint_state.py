...
class JointStatePlayer1:
    def __init__(self) -> None:
        ...
        self.dataFileLocation = os.path.join("/home/archit/Downloads", "my_csv.csv")
        try:
    ...
    def go_to_next_joint_state(self):
        if(self.index < len(self.dataFrame)):
            ...
            pose[0] = self.dataFrame.loc[self.index, 'joint_0']
            pose[1] = self.dataFrame.loc[self.index, 'joint_1']
            pose[2] = self.dataFrame.loc[self.index, 'joint_2']
            pose[3] = self.dataFrame.loc[self.index, 'joint_3']
            pose[4] = self.dataFrame.loc[self.index, 'joint_4']
            pose[5] = self.dataFrame.loc[self.index, 'joint_5']
            pose[6] = self.dataFrame.loc[self.index, 'joint_6']
